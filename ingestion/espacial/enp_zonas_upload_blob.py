...
y se guardan como GeoJSON en Azure Blob Storage bajo bronce-raw/espacial/.

    python ingestion/espacial/enp_zonas_upload_blob.py
...
class SpatialLayersBronzeIngestionPipeline:
    ...
    def run_enp_ingestion(self) -> Optional["gpd.GeoDataFrame"]:
        ...
        Flujo:
          ...
          3. Fallback: busca fichero manual en data/bronce/espacial/raw/enp/
        ...
        # Guardar
        blob_name = "espacial/enp/tenerife_espacios_naturales_protegidos.geojson"
    ...
    def run_zonas_turisticas_ingestion(self) -> Optional["gpd.GeoDataFrame"]:
        ...
        Flujo:
          ...
          2. Fallback: busca fichero manual en data/bronce/espacial/raw/zonas_turisticas/
        ...
        blob_name = "espacial/zonas_turisticas/tenerife_zonas_turisticas.geojson"
        self._save_geojson_to_blob(gdf_tenerife, blob_name)
