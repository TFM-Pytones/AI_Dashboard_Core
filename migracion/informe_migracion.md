...
Para optimizar el almacenamiento y reducir costes en la nube, hemos migrado el histórico en bruto (`raw_data`) de Neon a archivos binarios comprimidos en **Azure Blob Storage**.
